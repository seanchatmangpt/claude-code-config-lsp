//! AST-derived semantic tokens for Claude Code Config files.
//!
...
fn token_type_for(kind: &str) -> Option<u32> {
    match kind {
        ...
        "enumMember" => Some(T_ENUMMEMBER),

        "keyword" => Some(T_KEYWORD),

        "namespace" => Some(T_NAMESPACE),

        "property" => Some(T_PROPERTY),

        "string" => Some(T_STRING),

        "variable" => Some(T_VARIABLE),
...
mod witness {
    ...
    fn doc(src: &str) -> Document {
        ...
        parser
            ...
            .expect("Claude Code Config grammar");
